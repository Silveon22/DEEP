package silveon22.deep.achievement;
...
public class AchievementPageDeep extends AchievementPage {
	public final String name;
	public final ItemStack icon;

	public AchievementPageDeep(String name, ItemStack icon) {
		this.name = name;
		this.icon = icon;
	}
	...
	public @NotNull AchievementEntry onOpenAchievement() {
		return Objects.requireNonNull(this.getEntry(DeepAchievements.DELVE));
	}

	@Override
	public @Nullable IconCoordinate getBackgroundTile(ScreenAchievements screen, int i, Random random, int j, int k) {
		return TextureRegistry.getTexture("deep:block/abyssalrite");
	}
