...
public class WorldFeatureHiveHoney extends WorldFeature {
	private int blockId;
	...
	public WorldFeatureHiveHoney(int numberOfBlocks, Block<?> block) {
		this.blockId = DEEPBlocks.blockHoney.id();
