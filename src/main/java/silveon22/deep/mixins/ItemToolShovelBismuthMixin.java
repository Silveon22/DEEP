...
public class ItemToolShovelBismuthMixin extends ItemTool {
	protected ItemToolShovelBismuthMixin(String name, String namespaceId, int id, int damageDealt, ToolMaterial toolMaterial, Tag<Block<?>> tagEffectiveAgainst) {
