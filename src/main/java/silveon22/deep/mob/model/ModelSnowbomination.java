...
public class ModelSnowbomination extends ModelBiped {
    public ModelSnowbomination() {
        this(0.0F);
    }

    public ModelSnowbomination(float var1) {
    ...
    public void parts(float var1, float var2) {
        ...
        this.hair = new Cube(40, 0);
        this.hair.addBox(-12.0F, -10.0F, 0F, 8, 8, 0, var1);
