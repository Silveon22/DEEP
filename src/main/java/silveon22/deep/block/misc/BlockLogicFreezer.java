...
public class BlockLogicFreezer extends BlockLogicRotatable {
	...
	public ItemStack[] getBreakResult(World world, EnumDropCause dropCause, int meta, TileEntity tileEntity) {
		switch (dropCause) {
			...
			case SILK_TOUCH:
			case PISTON_CRUSH:
				return new ItemStack[]{new ItemStack(DEEPBlocks.freezerIdle)};
			default:
				return null;
		}
	}
	...
	public void animationTick(World world, int x, int y, int z, Random rand) {
		if (this.isActive) {
			...
			if (l == 4) {
				world.spawnParticle("snowshovel", poxX - f3, posY, posZ + f4, (double)0.0F, (double)0.0F, (double)0.0F, 0);
				world.spawnParticle("snowshovel", poxX - f3, posY, posZ + f4, (double)0.0F, (double)0.1F, (double)0.0F, 0);
			} else if (l == 5) {
				world.spawnParticle("snowshovel", poxX + f3, posY, posZ + f4, (double)0.0F, (double)0.0F, (double)0.0F, 0);
				world.spawnParticle("snowshovel", poxX + f3, posY, posZ + f4, (double)0.0F, (double)0.1F, (double)0.0F, 0);
			} else if (l == 2) {
				world.spawnParticle("snowshovel", poxX + f4, posY, posZ - f3, (double)0.0F, (double)0.0F, (double)0.0F, 0);
				world.spawnParticle("snowshovel", poxX + f4, posY, posZ - f3, (double)0.0F, (double)0.1F, (double)0.0F, 0);
			} else if (l == 3) {
				world.spawnParticle("snowshovel", poxX + f4, posY, posZ + f3, (double)0.0F, (double)0.0F, (double)0.0F, 0);
				world.spawnParticle("snowshovel", poxX + f4, posY, posZ + f3, (double)0.0F, (double)0.1F, (double)0.0F, 0);
			}
	...
	public boolean onBlockRightClicked(World world, int x, int y, int z, Player player, Side side, double xPlaced, double yPlaced) {
		if (!world.isClientSide) {
			...
			((displayFreezerScreen)player).deep$freezerScreen(tileentityfreezer);
		}

		return true;
	}

	public static void updateFreezerBlockState(boolean lit, @NotNull World world, int x, int y, int z) {
		...
		if (tileEntity == null) {
			...
			if (lit) {
				world.setBlockWithNotify(x, y, z, DEEPBlocks.freezerActive.id());
			} else {
				world.setBlockWithNotify(x, y, z, DEEPBlocks.freezerIdle.id());
			}
