...
public class BlockLogicExplosiveMushroom extends BlockLogicFlower {
	...
	public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity entity) {
		...
		if (entity instanceof Player) {
			...
			if (entity.tickCount % 2 == 0) {
				...
				world.playSoundEffect((Entity)null, SoundCategory.WORLD_SOUNDS, (double)x + (double)0.5F, (double)y + 0.1, (double)z + (double)0.5F, "random.explode", 0.7F, 0.7F);
			}
		}
